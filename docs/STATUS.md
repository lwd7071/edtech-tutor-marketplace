...
- Migration mới nhất trong repository: `V35__enable_rls_booking_learning_tables.sql` (RLS default-deny và REVOKE TRUNCATE trên 9 bảng Booking & Learning). Đã preflight sạch và apply Supabase thành công; Flyway validate/info xác nhận V35 `Success`.
