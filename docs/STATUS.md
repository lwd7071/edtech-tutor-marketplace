...
- Migration mới nhất trong repository: `V34__enable_rls_finance_tables.sql` (RLS default-deny và REVOKE TRUNCATE trên 8 bảng Finance). Đã preflight sạch và apply Supabase thành công; Flyway validate/info xác nhận V34 `Success`.
